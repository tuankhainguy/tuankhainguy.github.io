    ...
    <svg viewBox="0 0 256 292" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="256" height="292">
      <defs>
        <linearGradient id="node-a" x1="68.188%" x2="27.823%" y1="17.487%" y2="89.755%">
          ...
          <stop offset="63.52%" stop-color="#419637"/><stop offset="93.19%" stop-color="#3FA92D"/>
        ...
        <linearGradient id="node-c" x1="43.277%" x2="159.245%" y1="55.169%" y2="-18.306%">
          ...
          <stop offset="40.32%" stop-color="#54A044"/><stop offset="71.36%" stop-color="#66B848"/>
